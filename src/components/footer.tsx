...
async function shouldShowCTA() {
  ...
  if (!session?.user?.id) {
    return true; // Show CTA for non-authenticated users
  }
  ...
  return (
    <footer className="">
      <div className="mx-auto w-full max-w-screen-xl lg:py-12">
        ...
        {showCTA && (
            <div className="relative overflow-hidden bg-gradient-to-br from-neutral-900 to-neutral-800 py-16 px-4 sm:px-6 lg:px-8 rounded-2xl border border-neutral-800 mb-24">
                {/* Decorative elements */}
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-6">
                            ...
                            <div className="text-center sm:text-left">
                                ...
                                <p className="text-2xl font-bold text-white">$12<span className="text-sm text-gray-300">/month</span></p>
                            </div>
                        </div>
                    </div>
                </div>
