...
import { Home, Rss, PlusCircle, MessageCircle, Users, Search, User, LogOut, Settings } from 'lucide-react';
      ...
      <>
                        ...
                        {suggestions.map((char: Character) => (
                          ...
                          >
                            ...
                            <div className="flex-grow min-w-0">
                              ...
                              <div className="text-xs text-gray-500 dark:text-gray-400 truncate">{char.tagline}</div>
                            </div>
                          </li>
                        ))}
                      </ul>
        ...
        {!isChatRoute && 
          <div className="hidden md:flex flex-col items-center fixed left-0 top-12 bottom-0 w-16 bg-neutral-900 py-4 z-40">
            <SidebarContent isCreateOpen={isCreateOpen} setIsCreateOpen={setIsCreateOpen} />
          </div>      
        }
...
const SidebarContent: React.FC<SidebarContentProps> = ({ isCreateOpen, setIsCreateOpen, isMobile = false }) => {
    const router = useRouter();
    ...
    return (
      <div className={`flex ${isMobile ? 'flex-row justify-around w-full' : 'flex-col space-y-6'} items-center py-4`}>
